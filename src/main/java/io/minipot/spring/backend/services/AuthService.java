...
import io.minipot.spring.backend.DTO.LoginUserDTO;
import io.minipot.spring.backend.DTO.RegisterUserDTO;
import io.minipot.spring.backend.DTO.RequestResetPasswordDTO;
import io.minipot.spring.backend.DTO.ResetPasswordDTO;
import io.minipot.spring.backend.exceptions.ExistingAccountException;
import io.minipot.spring.backend.exceptions.NotVerifiedException;
import io.minipot.spring.backend.exceptions.ResetPasswordException;
import io.minipot.spring.backend.exceptions.TokenExpiredException;
import io.minipot.spring.backend.models.Role;
import io.minipot.spring.backend.models.User;
import io.minipot.spring.backend.repositories.RoleRepository;
import io.minipot.spring.backend.repositories.UserRepository;
import io.minipot.spring.backend.responses.LoginResponse;
import io.minipot.spring.backend.security.DatabaseUserDetails;
import io.minipot.spring.backend.utilities.EmailManager;
